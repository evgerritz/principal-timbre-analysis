...
if __name__ == '__main__':
    ...
    samplerate, samples = wavfile.read('./e4_pluck.wav')
    samples = samples[:,0]
    #cs5 = 554.37
    e4 = 329.63
    #plot_amps(cs5, samplerate, samples, smooth=False)
    plot_amps(e4, samplerate, samples, [0.25, 0.5] + list(range(1,29)), smooth=True)
    #get_envs(cs5, samplerate, samples, smooth=True)
